...
@app.route('/')
def home():
	return render_template('indexServer.html', temperature=temperatureValue, humidity=humidityValue, cds=cdsValue)
...
def getPir():
	...
	return render_template('pirServer.html', pir=pirValue)
